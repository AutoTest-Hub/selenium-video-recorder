 ...
 * 
 * This is the ORIGINAL FIXED version that resolves the multi-tab recording
 * issue in headless Chrome by creating separate DevTools sessions per tab.
 * 
 * Usage:
 * <pre>
 * VideoRecordInHeadless recorder = new VideoRecordInHeadless(logger, driver);
 * recorder.startRecording();
 * recorder.setAutoRebindEnabled(true); // For automatic tab switching
